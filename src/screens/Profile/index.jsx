...
const blueTheme = {
  primary: '#007BFF', // Warna biru utama
  light: '#5BC0DE',   // Warna biru muda
  dark: '#0056b3',    // Warna biru gelap
};
    ...
    <View style={styles.card}>
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Text style={{color: blueTheme.primary}}>Edit</Text>
        </TouchableOpacity>
            ...
            <View style={styles.formContainer}>
              ...
              <View
                ...
                <TouchableOpacity onPress={handleSavePost}>
                  <Text style={{color: blueTheme.primary}}>Simpan</Text>
                </TouchableOpacity>
              </View>
            </View>
          )}
...
const styles = StyleSheet.create({
  ...
  activeTab: {
    borderBottomWidth: 2,
    borderBottomColor: blueTheme.primary,
  },
